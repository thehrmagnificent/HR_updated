...
/**
 *
 * Settin Department and Designation
 *
 **/
...
const designation = document.getElementById("desig");
if (department && designation) {
  department.value = getDesignation().desig;
  designation.value = getDesignation().dept;

  
}

const setFormValues = (dept, desig) => {
  localStorage.setItem(
    "userForm",
    JSON.stringify({ dept: dept, desig: desig })
  );
};
